...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Otrzymałeś ten e-mail, ponieważ prosiłeś o wysłanie linku do zresetowania hasła w Rodzinnym losowaniu, kliknij w poniższy przycisk, aby ustawić nowe hasło')
